...
class User44Controller extends Controller
{
    public function dashboardPage44()
    {
        ...
        $getUser = $client->request('GET', "{$API_URL}/user44")->getBody()->getContents();
    ...
    public function profilePage44()
    {
        ...
        $getUser = $client->request('GET', "{$API_URL}/user44/{$user->id}")->getBody()->getContents();
        $getAgama = $client->request('GET', "{$API_URL}/agama44")->getBody()->getContents();
    ...
    public function detailPage44(Request $request, $id)
    {
        ...
        $client = new Client();
        $getUser = $client->request('GET', "{$API_URL}/user44/{$id}")->getBody()->getContents();
        $user = json_decode($getUser, true)['data'];
    ...
    public function putUserDetail44(Request $request)
    {
        ...
        $putUser = $client->request('PUT', "{$API_URL}/user44/{$user->id}", [
            'json' => [
                'name' => $request->name,
                'email' => $request->email,
    ...
    public function putUserAgama44(Request $request, $id)
    {
        ...
        $putUserAgama = $client->request('PUT', "{$API_URL}/user44/{$id}/agama", [
            'json' => [
    ...
    public function putUserStatus44(Request $request, $id)
    {
        ...
        $putUserStatus = $client->request('PUT', "{$API_URL}/user44/{$id}/status", [
            'json' => [
    ...
    public function putUserPassword44(Request $request)
    {
        ...
        $putUserPassword = $client->request('PUT', "{$API_URL}/user44/{$user->id}/password", [
            'json' => [
    ...
    public function putUserPhoto44(Request $request)
    {
        ...
        $putUserPhoto = $client->request('PUT', "{$API_URL}/user44/{$id}/photo", [
            'headers' => [
    ...
    public function putUserPhotoKTP44(Request $request)
    {
        $API_URL = env('API_URL', "44http://localhost/UAS_BE_V3421044-main/app/Http/Controllers/api/");
        ...
        $putUserPhoto = $client->request('PUT', "{$API_URL}/user44/{$id}/photoKTP", [
            'headers' => [
                'Accept' => 'application/json',
            ],
            'json' => [
    ...
    public function deleteUser44($id)
    {
        ...
        $deleteUser = $client->request('DELETE', "{$API_URL}/user44/{$id}", [
            'headers' => [
                'Accept' => 'application/json',
            ],
        ])->getBody()->getContents();
